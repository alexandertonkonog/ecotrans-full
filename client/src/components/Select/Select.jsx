...
const Select = (props) => {
    ...
    return (
        <div className={props.type === 1 ? "input-container select-container " + props.addClass : "input-container select-container select-container_without-label " + props.addClass}>
            {props.type === 1 && <div className="select__label">{ props.text } {props.req  && <span className="input_req">*</span>}</div>}
            <div className={selectClass}>
                <div className={props.value && selected ? "select__header select__header_selected" : "select__header"} onClick={clickHeaderCallback}>
