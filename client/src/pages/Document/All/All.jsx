...
import logo1 from '../../../images/document/icon1.svg';
import logo2 from '../../../images/document/icon2.svg';
import logo3 from '../../../images/document/icon3.svg';
import logo4 from '../../../images/document/icon4.svg';
import Sign from '../../Home/Sign/Sign';
import '../../../css/components/allGrid.css';

const All = () => {
    const menu = useSelector(state => state.main.menu);
    const data = menu.find(item => item.id === 4);
    ...
    return (
        <div className="all block">
            <div className="section-nav-container grid">
                <h1 className="main-title all__title">Документы</h1>
            </div>
